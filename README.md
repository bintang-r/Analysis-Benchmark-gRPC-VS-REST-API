...
_Baca dalam bahasa lain / Read in another language:_
...
- **Interactive Dashboard & Parameter Controller**:
  ![Dashboard Screenshot](https://raw.githubusercontent.com/bintang-r/Analysis-Benchmark-gRPC-VS-REST-API/main/screenshoot/gambar1.png)
- **Real-Time Network Communication Simulator**:
  ![Simulator Screenshot](https://raw.githubusercontent.com/bintang-r/Analysis-Benchmark-gRPC-VS-REST-API/main/screenshoot/gambar2.png)
- **Dynamic Academic Paper Tab**:
  ![Paper Screenshot](https://raw.githubusercontent.com/bintang-r/Analysis-Benchmark-gRPC-VS-REST-API/main/screenshoot/gambar3.png)
- **Additional Screenshot**:
  ![Additional Screenshot](https://raw.githubusercontent.com/bintang-r/Analysis-Benchmark-gRPC-VS-REST-API/main/screenshoot/gambar4.png)
...
2. **Interactive Network Flow Visualizer**:
   - **REST (HTTP/1.1)**: Simulates parallel sequential pipes with a maximum limit of 6 connections. Requests exceeding this limit wait in a visual queue at the client node (illustrating _Head-of-Line Blocking_).
...
_(Tambahkan tangkapan layar Anda di sini)_
...
2. **Visualisasi Aliran Jaringan Interaktif**:
   - **REST (HTTP/1.1)**: Mensimulasikan pipa sequential paralel dengan batas maksimal 6 koneksi. Request yang melebihi batas akan tertahan di antrean visual (`Queue: X`) pada node client (mengilustrasikan _Head-of-Line Blocking_).
